...
```{r include=FALSE}
terms_chp_17 <- c(terms_chp_17, "paired data")
```
...
include_graphics("06/figures/bootmeans2means.png")
```
...
```{r include=FALSE}
terms_chp_17 <- c(terms_chp_17, "one sample $t$-test", "two sample $t$-test", "paired $t$-test")
```
