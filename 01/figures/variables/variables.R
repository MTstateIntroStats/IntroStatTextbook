...
text(0.25, 0.5, 'quantitative')
rect(0.05,0.4, 0.45, 0.6)
arrows(0.45, 0.78, 0.34, 0.62, length=0.08)

text(0.9, 0.5, 'categorical')
rect(0.70,0.4, 1.10, 0.6)
arrows(0.76, 0.78, 0.85, 0.62, length=0.08)

text(0, 0.1, 'continuous', col=COL[6])
rect(-0.17, 0, 0.17, 0.2, border=COL[6])
arrows(0.13, 0.38, 0.05, 0.22, length=0.08)

text(0.39, 0.1, 'discrete', col=COL[6])
rect(0.25, 0, 0.53, 0.2, border=COL[6])
arrows(0.35, 0.38, 0.4, 0.22, length=0.08)

text(0.77, 0.105, 'nominal', col=COL[6])
