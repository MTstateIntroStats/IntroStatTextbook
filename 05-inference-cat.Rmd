...
2. *Success-failure condition.*
  ...
  \begin{eqnarray*}
  SE = \sqrt{\frac{\pi_1(1-\pi_1)}{n_1} + \frac{\pi_2(1-\pi_2)}{n_2}}
  \end{eqnarray*}
...
<!--
{Confidence intervals for $\pmb{\pi_1 - \pi_2}$}
-->
...
\begin{eqnarray*}
  SE(\hat{p}_1 -\hat{p}_2) = \sqrt{\frac{\pi_1(1-\pi_1)}{n_1} + \frac{\pi_2(1-\pi_2)}{n_2}}
  \end{eqnarray*}
```
