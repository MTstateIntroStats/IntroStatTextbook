...
temptbl %>%
 kable(caption = "The data above are now summarized using column proportions. Column proportions are particularly useful here since we can view the proportion of *buy* and *not buy* decisions in each group, and across the whole sample.") %>%
 kable_styling()
```
