...
```{r include=FALSE}
terms_chp_14 <- c("statistic", "parameter", "test statistic")
```
...
```{r include=FALSE}
terms_chp_14 <- c(terms_chp_14, "bootstrapping")
```
...
```{r include=FALSE}
terms_chp_14 <- c(terms_chp_14, "success-failure condition", "standard error of single proportion")
```
