...
scatterplot(sat~expend, lwd=3, data=SAT,pch=20,main="Expendature vs. SAT Score", smooth=F)
```

```{r echo=t, fig.height=5,fig.width=12}
par(mfrow=c(1,2))
levels(SAT$frac_40) <- c("yes", "no")
scatterplot(sat~expend+frac_40, lwd=3, data=SAT,pch=20,main="Expendature vs. SAT Score", smooth=F)
```
