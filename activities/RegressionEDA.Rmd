---
title: "Quantitative Exploratory Data Analysis Activity"
output:
...
The favstats function gives the summary statistics for a quantitative variable.
```{r}
...
```
7. Which range of IMBD scores have the highest frequency?
...
* Quartile 3 (Q3) - the avlue at the 75th percentile
* Maximum value 
...
10. Does there appear to be an association betwen 'Budget' and 'Revenue'? Explain.
