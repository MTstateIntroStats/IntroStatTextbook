...
```{r include=FALSE}
terms_chp_6 <- c("statistical inference", "hypothesis test", "confidence interval")
```
...
include_graphics("06/images/bumBa-KiKi.png")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "Central Limit Theorem", "sampling distribution")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "hypothesis test", "null hypothesis", "alternative hypothesis")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "p-value", "test statistic")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "normal curve", "normal model", "normal distribution")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "standard normal distribution")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "parameter")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "Z score")
```
...
```{r include=FALSE}
terms_chp_6 <- c(terms_chp_6, "percentile")
```
